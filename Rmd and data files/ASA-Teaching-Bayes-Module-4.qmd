...
### Short solution
There were 20000 MCMC iterations and 10000 for the warmup, meaning the last 10000 iterations were saved from each chain. Moreover, since ```thin = 10```, only 10\% of the iterations, which are 1000, were saved from each chain. With two chains, we have 2000 MCMC iterations saved. 
:::
